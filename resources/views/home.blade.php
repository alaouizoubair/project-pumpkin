      ...
      <md-list>
	      <md-item>
	      	<md-item-content md-ink-ripple layout="row" layout-align="start center">
	            ...
	            <div class="inset">Atteindre 100 inscriptions
	            </div>
	          </md-item-content>
	      </md-item>
    ...
    <div layout="column" class="relative" layout-fill role="main">
      <md-toolbar ng-show="!showSearch">
        <div class="md-toolbar-tools">
          ...
          <span flex></span>
          <h4 class="nb-inscrit">{{$nbInscriptions}} Inscrits</h4>
                      ...
                      <h2>Description</h2>
	                      <div layout="row" layout-sm="column" layout-align="center center">
		                      <div flex="65" flex-sm="100">
			                      <p class="description">
			                      L'<b>information</b> a toujours été la frontière entre le savoir et l'ignorance, entre la vie et la survie. Aujourd'hui, si l'<b>éducation</b> est la voie vers l'information, l'<b>orientation</b> serait la boussole. Pour cela, <b>La Passerelle</b> a un seul objectif: Orienter les jeunes <b>talents</b> <i>Marocains</i>  dans leur parcours scolaire. Pour atteindre cet objectif, votre <b>expérience</b> proffessionelle est importante, et nous vous encourageons à la partager.
			                      <br><br>
									...
									<br>
									Ces informations étant négligeable, voire même sans importance pour la plupart d'entre nous, risquent de jouer un rôle crucial dans l'orientation d'innombrables jeunes pour découvrir de nouveau horizon et saisir des <b>opportunités</b> qui semblent à ce jour improbables.
									</p>
		                        </div>
		                      <div flex>
				    		...
				    		<div flex="60" flex-sm="100">
				    			<form class="registration-form"  layout="column"  layout-align="center stretch" >
						    		...
						    		<div layout="row">
							    		<md-input-container flex >
								    		<label>Domaine*</label>
								    		<input name="domain" ng-model="user.domain" type="text" />
							    		</md-input-container>
							    		<md-input-container flex >
